...
**** CANCELLED we might be able to start Mero processes simultaneously :CANCELLED:

- State "CANCELLED"  from              [2019-08-24 Sat 13:27] \\
  This would require non-trivial changes in Mero.  We won't be doing those in the nearest future.
***** this requires m0mkfs's fid and endpoint to be different from those of m0d

*** ! testing & CI

**** [proto-bootstrap] script(s) for starting cluster, consul agents, Hare executables, etc.
- install Mero rpm
- insmod Mero kernel modules
- /etc./

*** @andriy

**** DONE [[[https://jts.seagate.com/browse/EOS-1427][EOS-1427]]] systemd scripts for hax

**** cfgen: ~consul-config.json~, ~consul-kv.json~

*** @kostya
- [[[https://jts.seagate.com/browse/EOS-1456][EOS-1456]]] Ensure that hax doesn't require confd to start

*** @mandar
- [[[https://jts.seagate.com/browse/EOS-1436][EOS-1436]]] hax: Remove dependency on the m0_halon_interface patch

- remove dependency on the ~m0_halon_interface~ patch
- broadcast ~m0_ha_msg~s to Mero processes
- handle ~m0_ha_link~ disconnects

*** @vvv
- [[[https://jts.seagate.com/browse/EOS-1433][EOS-1433]]] cfgen: ConfSdev and ConfDrive objects
- cfgen: complete confd.xc
