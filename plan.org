...
***** LNet protocol (lo/tcp/o2ib) selection

~m0genfacts --lnet-transport {tcp|o2ib}~, defaults to ~tcp~.

***** from roles to services
...
**** DONE [[[https://jts.seagate.com/browse/EOS-1244][EOS-1244]]] concurrency issues

**** [[[https://jts.seagate.com/browse/EOS-1247][EOS-1247]]] m0_ha_msg types

***** incoming/outgoing ha_links -- when to use which?
...
- use a bash script for starting Consul + hax + m0d(s)
- write an RFC
