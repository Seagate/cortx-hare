...
conf "$URL" set 'cluster>my-cluster>storage_set[0]>durability>sns>data=1'
conf "$URL" set 'cluster>my-cluster>storage_set[0]>durability>sns>parity=0'
conf "$URL" set 'cluster>my-cluster>storage_set[0]>durability>sns>spare=0'
...
conf "$URL" set 'server_node>SOME_MACHINE_ID>name=mynodename'
...
conf "$URL" set 'server_node>SOME_MACHINE_ID>storage>cvg[0]>data_devices[0]=/dev/sda'
conf "$URL" set 'server_node>SOME_MACHINE_ID>storage>cvg[0]>data_devices[1]=/dev/sdb'
conf "$URL" set 'server_node>SOME_MACHINE_ID>storage>cvg[0]>metadata_devices[0]=/dev/meta'
