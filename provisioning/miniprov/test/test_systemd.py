...
[Service]
# TODO: '$HOME/seagate/cortx/hare' prefix can be different, e.g. '/usr'
SyslogIdentifier=hare-hax
Environment=PYTHONPATH=$HOME/seagate/cortx/hare/lib64/python3.6/site-packages:$HOME/seagate/cortx/hare/lib/python3.6/site-packages
ExecStart=/bin/sh -c 'cd $HOME/seagate/var/motr/hax && exec $HOME/seagate/cortx/hare/bin/hax'
KillMode=process'''
